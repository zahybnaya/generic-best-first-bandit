...
grep '^[0-9],' *.csv | sed 's/K/000,/g' | sed 's/9VS2/Trails,DP/g' | sed 's/6VS2/CDP,DP/g' | sed 's/9VS1/Trails,MC/g' | sed 's/6VS1/CDP,MC/g' | sed 's/B/,/g' | sed 's/:/,/g' | sed 's/ /,/g' | sed 's/.csv//g' >> ${RESULT_FILE}
