...
v=data[data$seg==1 & data$a2 == "CDP",]
vmcdp=data[data$seg==1 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
...
v=data[data$seg==4 & data$a2 == "CDP",]
vmcdp=data[data$seg==4 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
...
v=data[data$seg==8 & data$a2 == "CDP",]
vmcdp=data[data$seg==8 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
...
# Display for seg=8 and against MC 
v=data[data$seg==16 & data$a2 == "CDP",]
vmcdp=data[data$seg==16 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
...
# Display for seg=8 and against MC 
v=data[data$seg==24 & data$a2 == "CDP",]
vmcdp=data[data$seg==24 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
...
# Display for seg=8 and against MC 
v=data[data$seg==48 & data$a2 == "CDP",]
vmcdp=data[data$seg==48 & data$a1 == "CDP" & data$a2 == "MC",]
if(nrow(vmcdp)>0){
	vmcdp$a1<-"MC"
	vmcdp$a2<-"CDP"
	tmp=vmcdp$max_win
