...
#
#
RESULT_FILE='seg_mancala_data_c05_a.csv'
...
grep '^[0-9],' *.csv | sed 's/K/000,/g' | sed 's/9VS2/Trails,DP/g' | sed 's/6VS2/CDP,DP/g' | sed 's/1VS2/MC,DP/g' | sed 's/9VS2/Trails,CDP/g' | sed 's/2VS6/DP,CDP/g' | sed 's/B/,/g' | sed 's/:/,/g' | sed 's/ /,/g' | sed 's/.csv//g' >> ${RESULT_FILE}
