...
ggames: common.h domain genericGames.c uct.c minmax.c heuristic.c move.c board.c util.c random.c bfb.c type.h type.c
	gcc genericGames.c uct.c bfb.c type.c util.c domain.o -o ggames $(CFLAGS) 
